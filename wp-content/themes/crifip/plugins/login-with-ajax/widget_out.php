...
?>
	...
	<div id="LoginWithAjax" class="default"><?php //ID must be here, and if this is a template, class name should be that of template directory ?>
        ...
        <form name="LoginWithAjax_Form" id="LoginWithAjax_Form" action="<?php echo $this->url_login; ?>" method="post">
                        ...
                        <input autocomplete="off" type="text" name="log" id="lwa_user_login" placeholder="Nom d'utilisateur" class="input" value="<?php echo attribute_escape(stripslashes($user_login)); ?>" />
                        <div class="clearfix"></div>
                        <label><?php _e( 'Password' ) ?></label>
                        <input autocomplete="off" type="password" placeholder="Mot de passe"  name="pwd" id="lwa_user_pass" class="input" value="" />
                        ...
                        <input name="rememberme" type="checkbox" id="lwa_rememberme" value="forever" /> <label id="rememberme_label"><?php _e( 'Remember Me' ) ?></label>
