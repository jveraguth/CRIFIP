...
<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
				<nav id="nav-above" class="navigation card">
...
<?php endif; ?>
				...
				<nav id="nav-below" class="navigation card">
...
<div id="box" class="twocol">
                    	<ul>
                        	<li><a href="http://www.facebook.com/share.php?u=<?php the_permalink() ?>" target="blank" rel="nofollow" title="Partagez cet article sur Facebook">Partager sur facebook</a></li>
                            <li><a href="http://twitter.com/home?status=<?php the_permalink() ?>" target="blank" rel="nofollow" title="Partagez cet article sur Twitter">Partager sur Twitter</a></li>
                            <!--<li><button class="fsButton">Request</button></li>-->
                        </ul>
                    </div>

<div class="threecol last card">
